        ...
        <div>
            ...
            <section className="product-details-section pt-120 pb-115">
                ...
                <div className="container">
                    <div className="product-details-wrapper mb-30 w-full" style={{ width: '100%' }}>
                        <div className="row">
                            <img
                                src={item?.image}
                                alt={item.name}
                            ...
                            />
                            <div className="col-lg-8 col-md-10" style={{ paddingLeft: '30px' }}>
                                <div className="product-info mt-30">
                                    ...
                                    >
                                        ...
                                        />
                                        <span className="underline text-white" style={{ fontSize: '20px' }}>
                                            Get Price
                                        </span>
                                    </button>
                                ...
                                <Tab.Container defaultActiveKey="description">
                                    <div className="description-tabs">
                                        <Nav as="ul" className="nav nav-tabs">
                                            <Nav.Item as="li">
                                                <Nav.Link as="a" href="#description" eventKey="description">
                                                    Description
                                                </Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item as="li">
